      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div
          ...
          <div class="header-top-info">
            <a href="tel:+23-345-67890">Call Us : <span>+91-9810971518</span></a>
            <a href="kaynatkazi@gmail.com"><i class="fa fa-envelope mr-2"></i><span>kaynatkazi@gmail.com</span></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <div
            ...
            <!--             <form class="form-lg-inline my-2 my-md-0 ml-lg-4 text-center">
              <a href="contact.php" class="btn btn-solid-border btn-round-full"
                >Get a Quote</a
              >
            </form> -->
          </div>

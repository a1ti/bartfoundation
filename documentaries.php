    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-4 text-lg">Documentaries on India’s Heritage</h1>
          <span class="text-white">Telling Stories Through Film</span>
        </div>
      </div>
    </div>
  </div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="about-item pr-3 mb-5 mb-lg-0 cta-item bg-white p-5 rounded">
					<h2 class="mt-3 mb-4 position-relative content-title" style="color: black;">Telling Stories Through Film</h2>
					<p style="color: black;">Our documentaries delve deep into the tangible and intangible heritage of India, bringing history to life for modern audiences. We also highlight UNESCO World Heritage Sites with authentic narratives and captivating visuals.</p>
				    
                       <h2 class="mt-3 mb-4 position-relative content-title" style="color: black;">What We Create:</h2> 
                            <p class="mb-0 text-black">
                                <i class="fas fa-hand-point-right text-warning mr-2"></i>
                                <b>Cultural Documentaries: </b>Exploring traditions, music, dance, and craftsmanship.
                            </p>
                             <p class="mb-0 text-black">
                                <i class="fas fa-hand-point-right text-warning mr-2"></i>
                                <b>Historical Narratives: </b>Showcasing ancient monuments, temples, forts, and architecture.
                            </p>
                             <p class="mb-0 text-black">
                                <i class="fas fa-hand-point-right text-warning mr-2"></i>
                                <b>UNESCO World Heritage Features: </b> Documenting India’s globally recognized heritage sites.
                            </p>

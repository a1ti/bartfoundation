...
<html lang="en">
  ...
  <title>E-Books & Coffee Table Books</title>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-4 text-lg">E-Books & Coffee Table Books</h1>
          <span class="text-white">Digital Access to Timeless Heritage</span>
        </div>
      </div>
    </div>
  </div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="about-item pr-3 mb-5 mb-lg-0 cta-item bg-white p-5 rounded">
					<h2 class="mt-3 mb-4 position-relative content-title" style="color: black;">Digital Access to Timeless Heritage</h2>
					<p style="color: black;">We create visually stunning e-books and coffee table books that combine breathtaking imagery with compelling narratives. These publications make India’s heritage accessible to a global audience at the click of a button.</p>
				    
                       <h2 class="mt-3 mb-4 position-relative content-title" style="color: black;">Highlights:</h2> 
                            <p class="mb-0 text-black">
                                <i class="fas fa-hand-point-right text-warning mr-2"></i>
                                <b>Interactive Design: </b> Enhanced visuals, easy navigation.
                            </p>
                             <p class="mb-0 text-black">
                                <i class="fas fa-hand-point-right text-warning mr-2"></i>
                                <b>Cultural Narratives: </b>Capturing traditions, festivals, crafts, and architecture.
                            </p>
                             <p class="mb-0 text-black">
                                <i class="fas fa-hand-point-right text-warning mr-2"></i>
                                <b>Perfect for Gifting & Collecting: </b> Elegant designs ideal for coffee tables and cultural showcases.
                            </p>

...
<body>
	...
	<div class="main-wrapper " style="background-image:url('images/bg/43584.jpg')">
		...
		<section class=" bg-1" style="padding: 35px 0;">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
		...
		<section class="section counter " style="background: #333333 ; padding-bottom: 15px; padding-top: 15px;">
			<div class="container">
											...
											<div class="col-lg-4 col-md-6 col-sm-6">
												<div class="team-item-wrap ">
													...
													<div class="team-item-content cta-item   rounded">
														...
														<!-- YouTube link -->
														<p>
															<a href="https://www.youtube.com/watch?v=rQObAWzSECk&list=PLO--blk_xXn9AGpYOJo_v2dj6Xd4Uw9on&index=5" target="_blank" class="text-primary">
																▶ Watch on YouTube
															</a>
														</p>
														<!-- More link -->
